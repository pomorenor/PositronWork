...
TEMPLATE_USUAL_CALC="/home/pohl/Desktop/PositronWork/NobleGasesDimers/Kripton/template_usual.lowdin"
...
for STEP in "${!DIST[@]}"; do
	...
	#sed "12s|POTENTIALCHANGE|KR$STEP|g" $TEMPLATE_ONLY_P > $LOWDIN_FILE_POSI
	...
	sed -i "17s|POTENTIALCHANGE|KR$STEP|g" $LOWDIN_FILE_USUAL
