...
if len(sys.argv) > 1:
    potentialName = sys.argv[1] + '.POT0'
else:
    print ("Since you did not provide a name I gave it POT0.POT0")
    potentialName = 'POT0.POT0'
#    exit()

outFile = open (potentialName,"w")

# units we assume input given in Bohrs already
angstromToBohr = 1.0
...
# benzene example
#molecule = """
#C  0.0000   1.4066  0.0000 8.709 2.25 
#C  1.2182   0.7033  0.0000 8.709 2.25 
#C  1.2182  -0.7033  0.0000 8.709 2.25 
#C  0.0000  -1.4066  0.0000 8.709 2.25 
#C -1.2182  -0.7033  0.0000 8.709 2.25 
#C -1.2182   0.7033  0.0000 8.709 2.25 
#H  0.0000   2.4998  0.0000 1.435  2.25 
#H  2.1649   1.2499  0.0000 1.435  2.25 
#H  2.1649  -1.2499  0.0000 1.435  2.25 
#H  0.0000  -2.4998  0.0000 1.435  2.25 
#H -2.1649  -1.2499  0.0000 1.435  2.25 
#H -2.1649   1.2499  0.0000 1.435  2.25 
...
molecule = """
Ar  0.0   0.0     0.0    11.1  1.710
Ar  34.6   0.0000  0.0000 11.1  1.710
"""
...
for i in range(0,n_atoms):    
    ...
    molecule[i][3] = round(float(molecule[i][3])*angstromToBohr,4)
