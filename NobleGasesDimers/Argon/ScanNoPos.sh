...
TEMPLATE_USUAL_CALC="/home/pohl/Desktop/PositronWork/NobleGasesDimers/Argon/template_nopos.lowdin"
...
for STEP in "${!DIST[@]}"; do
	...
	LOWDIN_FILE_USUAL="nopos_$STEP.lowdin"
	LOWDIN_OUTPUT_USUAL="nopos_$STEP.out"
	
	echo -e "Editing LOWDIN files \n"
	#sed "12s|POTENTIALCHANGE|JOR$STEP|g" $TEMPLATE_ONLY_P > $LOWDIN_FILE_POSI
	...
	#sed -i "17s|POTENTIALCHANGE|JOR$STEP|g" $LOWDIN_FILE_USUAL
