...
#LOWDIN_OUTPUT=$4
#DATA_RESULTS=$5
TEMPLATE_ONLY_P="/home/pmorenor/Desktop/PositronWork/Be2_OCT17/template_ee.lowdin"
...
for STEP in "${!DIST[@]}"; do
	...
	sed "14s|POTENTIALCHANGE|T$NEW_STEP|g" $TEMPLATE_ONLY_P > $LOWDIN_FILE_POSI
	...
	sed -i "17s|POTENTIALCHANGE|VPC$STEP|g" $LOWDIN_FILE_USUAL
